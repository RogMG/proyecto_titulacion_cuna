...
import mx.edu.tecnologicodecoacalco.proyecto_titulacion.dashboard.appconection.presentation.view.AppConnectionFragment
        ...
        binding.bottomNavigationBar.setOnItemSelectedListener {
            when(it.itemId){
                ...
                R.id.app_conection_fragment -> {
                    replaceFragmentView(AppConnectionFragment())
                    true
                }
